...
int database_getemployee_byrfid(byte[],byte[]);//send an empty byte array which gets filled with the result of the search. Parameter for search is the 12byte RFID char array
